"""Plot the forced-turbulence summary diagnostics for a `.input` case."""
...
def _plot_summary(
    ...
    figure_path = output_dir / "forced_turbulence_summary.png"
...
def main() -> None:
    ...
    if not isinstance(current, State):
        raise ValueError("Initial-condition builder did not return a State.")
