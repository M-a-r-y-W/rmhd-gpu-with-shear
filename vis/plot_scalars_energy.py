...
def _default_columns(fieldnames: list[str]) -> list[str]:
    preferred = [
        "elsasser_energy_plus",
        "elsasser_energy_minus",
        "alfvenic_energy",
...
def main(argv: list[str] | None = None) -> Path:
    ...
    alfvenic_energy = columns["elsasser_energy_plus"] + columns["elsasser_energy_minus"]
    ax.plot(time, alfvenic_energy, ls="--", lw=3, label="elsasser alfvenic energy", color="tab:orange")
